...
var map, pc, bc;
function draw(activeData, data2014, data2010, data2006, commData, data2002, pcYear, sweden_map_json){
  
  map = new Map(data2014, data2010, data2006, commData, data2002, pcYear, sweden_map_json);
  pc = new pc(pcYear);
  bc = new bc(commData);
}
